...
public class EtchingCounter : BaseCounter
{
    ...
    [SerializeField] private CleaningRecipeSO[] etchingRecipeSOArray ;
    [SerializeField] private GameObject etchingMiniGame;
    ...
    public override void InteractAlternate(Player player)
    {
        if(HasFabObject() && HasRecipeWithInput(GetFabObject().GetFabObjectSO()))
        {
            ...
            GameObject minigame = Instantiate(etchingMiniGame, Vector3.zero, Quaternion.identity);
    ...
    private FabObjectSO GetOutputForInput(FabObjectSO inputCleaningObjectSO)
    {
        ...
        foreach (CleaningRecipeSO cleaningRecipeSO in etchingRecipeSOArray)
        {
