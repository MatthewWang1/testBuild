...
public class OxidationCounter : BaseCounter
{

    [SerializeField] private CleaningRecipeSO[] cleaningRecipeSOArray ;
    [SerializeField] private GameObject oxidationMiniGame;
    ...
    public override void InteractAlternate(Player player)
    {
        ...
        {
            // do oxidation minigame
            // if complete minigame do the next 3 lines to output next wafer

            GameInputs.Instance.DisablePlayerActions();
            GameObject minigame = Instantiate(oxidationMiniGame, Vector3.zero, Quaternion.identity);
